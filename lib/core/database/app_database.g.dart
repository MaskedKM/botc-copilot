...
class $GamesTable extends Games with TableInfo<$GamesTable, Game> {
  ...
  static const VerificationMeta _myMinionIdsJsonMeta = const VerificationMeta(
    'myMinionIdsJson',
  );
  @override
  late final GeneratedColumn<String> myMinionIdsJson = GeneratedColumn<String>(
    'my_minion_ids_json',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _myDemonPlayerIdMeta = const VerificationMeta(
    'myDemonPlayerId',
  );
  @override
  late final GeneratedColumn<int> myDemonPlayerId = GeneratedColumn<int>(
    'my_demon_player_id',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _myEvilTeammatesJsonMeta =
      const VerificationMeta('myEvilTeammatesJson');
  @override
  late final GeneratedColumn<String> myEvilTeammatesJson =
      GeneratedColumn<String>(
        'my_evil_teammates_json',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('my_minion_ids_json')) {
      context.handle(
        _myMinionIdsJsonMeta,
        myMinionIdsJson.isAcceptableOrUnknown(
          data['my_minion_ids_json']!,
          _myMinionIdsJsonMeta,
        ),
      );
    }
    if (data.containsKey('my_demon_player_id')) {
      context.handle(
        _myDemonPlayerIdMeta,
        myDemonPlayerId.isAcceptableOrUnknown(
          data['my_demon_player_id']!,
          _myDemonPlayerIdMeta,
        ),
      );
    }
    if (data.containsKey('my_evil_teammates_json')) {
      context.handle(
        _myEvilTeammatesJsonMeta,
        myEvilTeammatesJson.isAcceptableOrUnknown(
          data['my_evil_teammates_json']!,
          _myEvilTeammatesJsonMeta,
        ),
      );
    }
  ...
  Game map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Game(
      ...
      myMinionIdsJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}my_minion_ids_json'],
      ),
      myDemonPlayerId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}my_demon_player_id'],
      ),
      myEvilTeammatesJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}my_evil_teammates_json'],
      ),
...
class Game extends DataClass implements Insertable<Game> {
  ...
  const Game({
    ...
    this.myMinionIdsJson,
    this.myDemonPlayerId,
    this.myEvilTeammatesJson,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || myMinionIdsJson != null) {
      map['my_minion_ids_json'] = Variable<String>(myMinionIdsJson);
    }
    if (!nullToAbsent || myDemonPlayerId != null) {
      map['my_demon_player_id'] = Variable<int>(myDemonPlayerId);
    }
    if (!nullToAbsent || myEvilTeammatesJson != null) {
      map['my_evil_teammates_json'] = Variable<String>(myEvilTeammatesJson);
    }
    {
  ...
  GamesCompanion toCompanion(bool nullToAbsent) {
    return GamesCompanion(
      ...
      myMinionIdsJson: myMinionIdsJson == null && nullToAbsent
          ? const Value.absent()
          : Value(myMinionIdsJson),
      myDemonPlayerId: myDemonPlayerId == null && nullToAbsent
          ? const Value.absent()
          : Value(myDemonPlayerId),
      myEvilTeammatesJson: myEvilTeammatesJson == null && nullToAbsent
          ? const Value.absent()
          : Value(myEvilTeammatesJson),
  ...
  factory Game.fromJson(
    ...
    return Game(
      ...
      myMinionIdsJson: serializer.fromJson<String?>(json['myMinionIdsJson']),
      myDemonPlayerId: serializer.fromJson<int?>(json['myDemonPlayerId']),
      myEvilTeammatesJson: serializer.fromJson<String?>(
        json['myEvilTeammatesJson'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'myMinionIdsJson': serializer.toJson<String?>(myMinionIdsJson),
      'myDemonPlayerId': serializer.toJson<int?>(myDemonPlayerId),
      'myEvilTeammatesJson': serializer.toJson<String?>(myEvilTeammatesJson),
  ...
  Game copyWith({
    ...
    Value<String?> myMinionIdsJson = const Value.absent(),
    Value<int?> myDemonPlayerId = const Value.absent(),
    Value<String?> myEvilTeammatesJson = const Value.absent(),
    HelpLevel? helpLevel,
  }) => Game(
    id: id ?? this.id,
    ...
    demonBluffsJson: demonBluffsJson.present
        ...
        : this.demonBluffsJson,
    myMinionIdsJson: myMinionIdsJson.present
        ? myMinionIdsJson.value
        : this.myMinionIdsJson,
    myDemonPlayerId: myDemonPlayerId.present
        ? myDemonPlayerId.value
        : this.myDemonPlayerId,
    myEvilTeammatesJson: myEvilTeammatesJson.present
        ? myEvilTeammatesJson.value
        : this.myEvilTeammatesJson,
  ...
  Game copyWithCompanion(GamesCompanion data) {
    return Game(
      ...
      demonBluffsJson: data.demonBluffsJson.present
          ...
          : this.demonBluffsJson,
      myMinionIdsJson: data.myMinionIdsJson.present
          ? data.myMinionIdsJson.value
          : this.myMinionIdsJson,
      myDemonPlayerId: data.myDemonPlayerId.present
          ? data.myDemonPlayerId.value
          : this.myDemonPlayerId,
      myEvilTeammatesJson: data.myEvilTeammatesJson.present
          ? data.myEvilTeammatesJson.value
          : this.myEvilTeammatesJson,
  ...
  String toString() {
    return (StringBuffer('Game(')
          ...
          ..write('myMinionIdsJson: $myMinionIdsJson, ')
          ..write('myDemonPlayerId: $myDemonPlayerId, ')
          ..write('myEvilTeammatesJson: $myEvilTeammatesJson, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Game &&
          ...
          other.myMinionIdsJson == this.myMinionIdsJson &&
          other.myDemonPlayerId == this.myDemonPlayerId &&
          other.myEvilTeammatesJson == this.myEvilTeammatesJson &&
...
class GamesCompanion extends UpdateCompanion<Game> {
  ...
  final Value<String?> myMinionIdsJson;
  final Value<int?> myDemonPlayerId;
  final Value<String?> myEvilTeammatesJson;
  ...
  const GamesCompanion({
    ...
    this.myMinionIdsJson = const Value.absent(),
    this.myDemonPlayerId = const Value.absent(),
    this.myEvilTeammatesJson = const Value.absent(),
  ...
  static Insertable<Game> custom({
    ...
    Expression<String>? myMinionIdsJson,
    Expression<int>? myDemonPlayerId,
    Expression<String>? myEvilTeammatesJson,
    ...
    return RawValuesInsertable({
      ...
      if (myMinionIdsJson != null) 'my_minion_ids_json': myMinionIdsJson,
      if (myDemonPlayerId != null) 'my_demon_player_id': myDemonPlayerId,
      if (myEvilTeammatesJson != null)
        'my_evil_teammates_json': myEvilTeammatesJson,
  ...
  GamesCompanion copyWith({
    ...
    Value<String?>? myMinionIdsJson,
    Value<int?>? myDemonPlayerId,
    Value<String?>? myEvilTeammatesJson,
    ...
    return GamesCompanion(
      ...
      myMinionIdsJson: myMinionIdsJson ?? this.myMinionIdsJson,
      myDemonPlayerId: myDemonPlayerId ?? this.myDemonPlayerId,
      myEvilTeammatesJson: myEvilTeammatesJson ?? this.myEvilTeammatesJson,
      helpLevel: helpLevel ?? this.helpLevel,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (myMinionIdsJson.present) {
      map['my_minion_ids_json'] = Variable<String>(myMinionIdsJson.value);
    }
    if (myDemonPlayerId.present) {
      map['my_demon_player_id'] = Variable<int>(myDemonPlayerId.value);
    }
    if (myEvilTeammatesJson.present) {
      map['my_evil_teammates_json'] = Variable<String>(
        myEvilTeammatesJson.value,
      );
    }
...
class $PlayersTable extends Players with TableInfo<$PlayersTable, Player> {
  ...
  static const VerificationMeta _abilityUsedMeta = const VerificationMeta(
    'abilityUsed',
  );
  @override
  late final GeneratedColumn<bool> abilityUsed = GeneratedColumn<bool>(
    'ability_used',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("ability_used" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  static const VerificationMeta _suspectedDrunkMeta = const VerificationMeta(
    'suspectedDrunk',
  );
  @override
  late final GeneratedColumn<bool> suspectedDrunk = GeneratedColumn<bool>(
    'suspected_drunk',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("suspected_drunk" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  static const VerificationMeta _revivedDayMeta = const VerificationMeta(
    'revivedDay',
  );
  @override
  late final GeneratedColumn<int> revivedDay = GeneratedColumn<int>(
    'revived_day',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('ability_used')) {
      context.handle(
        _abilityUsedMeta,
        abilityUsed.isAcceptableOrUnknown(
          data['ability_used']!,
          _abilityUsedMeta,
        ),
      );
    }
    if (data.containsKey('suspected_drunk')) {
      context.handle(
        _suspectedDrunkMeta,
        suspectedDrunk.isAcceptableOrUnknown(
          data['suspected_drunk']!,
          _suspectedDrunkMeta,
        ),
      );
    }
    if (data.containsKey('revived_day')) {
      context.handle(
        _revivedDayMeta,
        revivedDay.isAcceptableOrUnknown(data['revived_day']!, _revivedDayMeta),
      );
    }
  ...
  Player map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Player(
      ...
      abilityUsed: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}ability_used'],
      )!,
      suspectedDrunk: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}suspected_drunk'],
      )!,
      revivedDay: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}revived_day'],
      ),
...
class Player extends DataClass implements Insertable<Player> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || revivedDay != null) {
      map['revived_day'] = Variable<int>(revivedDay);
    }
  ...
  PlayersCompanion toCompanion(bool nullToAbsent) {
    return PlayersCompanion(
      ...
      revivedDay: revivedDay == null && nullToAbsent
          ? const Value.absent()
          : Value(revivedDay),
  ...
  factory Player.fromJson(
    ...
    return Player(
      ...
      revivedDay: serializer.fromJson<int?>(json['revivedDay']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'revivedDay': serializer.toJson<int?>(revivedDay),
  ...
  Player copyWith({
    ...
    bool? abilityUsed,
    bool? suspectedDrunk,
    Value<int?> revivedDay = const Value.absent(),
    bool? fakeDead,
  }) => Player(
    id: id ?? this.id,
    ...
    revivedDay: revivedDay.present ? revivedDay.value : this.revivedDay,
  ...
  Player copyWithCompanion(PlayersCompanion data) {
    return Player(
      ...
      deathCause: data.deathCause.present
          ...
          : this.deathCause,
      abilityUsed: data.abilityUsed.present
          ? data.abilityUsed.value
          : this.abilityUsed,
      suspectedDrunk: data.suspectedDrunk.present
          ? data.suspectedDrunk.value
          : this.suspectedDrunk,
      revivedDay: data.revivedDay.present
          ? data.revivedDay.value
          : this.revivedDay,
  ...
  bool operator ==(Object other) =>
      ...
      (other is Player &&
          ...
          other.revivedDay == this.revivedDay &&
...
class PlayersCompanion extends UpdateCompanion<Player> {
  ...
  const PlayersCompanion({
    ...
    this.revivedDay = const Value.absent(),
  ...
  static Insertable<Player> custom({
    ...
    return RawValuesInsertable({
      ...
      if (revivedDay != null) 'revived_day': revivedDay,
  ...
  PlayersCompanion copyWith({
    ...
    return PlayersCompanion(
      ...
      abilityUsed: abilityUsed ?? this.abilityUsed,
      suspectedDrunk: suspectedDrunk ?? this.suspectedDrunk,
      revivedDay: revivedDay ?? this.revivedDay,
      fakeDead: fakeDead ?? this.fakeDead,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (abilityUsed.present) {
      map['ability_used'] = Variable<bool>(abilityUsed.value);
    }
    if (suspectedDrunk.present) {
      map['suspected_drunk'] = Variable<bool>(suspectedDrunk.value);
    }
    if (revivedDay.present) {
      map['revived_day'] = Variable<int>(revivedDay.value);
    }
    if (fakeDead.present) {
...
class $DayRecordsTable extends DayRecords
  ...
  @override
  late final GeneratedColumn<bool> nightConfirmed = GeneratedColumn<bool>(
    'night_confirmed',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('night_confirmed')) {
      context.handle(
        _nightConfirmedMeta,
        nightConfirmed.isAcceptableOrUnknown(
          data['night_confirmed']!,
          _nightConfirmedMeta,
        ),
      );
    }
  ...
  DayRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DayRecord(
      ...
      nightConfirmed: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}night_confirmed'],
      )!,
...
class $$GamesTableFilterComposer extends Composer<_$AppDatabase, $GamesTable> {
  ...
  ColumnFilters<String> get myMinionIdsJson => $composableBuilder(
    column: $table.myMinionIdsJson,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get myDemonPlayerId => $composableBuilder(
    column: $table.myDemonPlayerId,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get myEvilTeammatesJson => $composableBuilder(
    column: $table.myEvilTeammatesJson,
    builder: (column) => ColumnFilters(column),
  );
...
class $$GamesTableOrderingComposer
  ...
  ColumnOrderings<String> get myMinionIdsJson => $composableBuilder(
    column: $table.myMinionIdsJson,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get myDemonPlayerId => $composableBuilder(
    column: $table.myDemonPlayerId,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get myEvilTeammatesJson => $composableBuilder(
    column: $table.myEvilTeammatesJson,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$GamesTableAnnotationComposer
  ...
  GeneratedColumn<String> get myMinionIdsJson => $composableBuilder(
    column: $table.myMinionIdsJson,
    builder: (column) => column,
  );

  GeneratedColumn<int> get myDemonPlayerId => $composableBuilder(
    column: $table.myDemonPlayerId,
    builder: (column) => column,
  );

  GeneratedColumn<String> get myEvilTeammatesJson => $composableBuilder(
    column: $table.myEvilTeammatesJson,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                myMinionIdsJson: myMinionIdsJson,
                myDemonPlayerId: myDemonPlayerId,
                myEvilTeammatesJson: myEvilTeammatesJson,
                helpLevel: helpLevel,
              ),
...
class $$PlayersTableFilterComposer
  ...
  ColumnFilters<bool> get abilityUsed => $composableBuilder(
    column: $table.abilityUsed,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<int> get revivedDay => $composableBuilder(
    column: $table.revivedDay,
    builder: (column) => ColumnFilters(column),
  );
...
class $$PlayersTableOrderingComposer
  ...
  ColumnOrderings<bool> get abilityUsed => $composableBuilder(
    column: $table.abilityUsed,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<bool> get suspectedDrunk => $composableBuilder(
    column: $table.suspectedDrunk,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get revivedDay => $composableBuilder(
    column: $table.revivedDay,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$PlayersTableAnnotationComposer
  ...
  GeneratedColumn<bool> get abilityUsed => $composableBuilder(
    column: $table.abilityUsed,
    builder: (column) => column,
  );

  GeneratedColumn<bool> get suspectedDrunk => $composableBuilder(
    column: $table.suspectedDrunk,
    builder: (column) => column,
  );

  GeneratedColumn<int> get revivedDay => $composableBuilder(
    column: $table.revivedDay,
    builder: (column) => column,
  );
